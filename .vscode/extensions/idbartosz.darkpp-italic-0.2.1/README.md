# Dark++ Italic Theme <img src="https://github.com/idbartosz/vscode-darkpp-italic/raw/HEAD/icon.png" alt="drawing" height="35"/>
...
![Theme Screenshot](https://github.com/idbartosz/vscode-darkpp-italic/raw/HEAD/images/closeup.png)
## Comparison
Screenshot of dummy JavaScript/React { **left**: Dark++ Italic, **right**: Dark+ (default) } - zoom in to see the details.

![Theme Screenshot](https://github.com/idbartosz/vscode-darkpp-italic/raw/HEAD/images/screenshot.png)
## Install
### ⚠️ **IMPORTANT NOTES**
---
...
## Changelog
You can take a look at the changelog [here](https://github.com/idbartosz/vscode-darkpp-italic/blob/HEAD/CHANGELOG.md).
