...
settings in your `settings.json` file, see [Issue [#16](https://github.com/lehni/vscode-titlebar-less-macos/issues/16)](https://github.com/subframe7536/vscode-custom-ui-style/issues/16):
...
[Issue [#52](https://github.com/lehni/vscode-titlebar-less-macos/issues/52)](https://github.com/drcika/apc-extension/issues/52):
...
```jsonc
{
  ...
  "customizeUI.stylesheet": {
    ...
    // Show the host button, and make it as wide as the .activitybar.
    ".statusbar #status\\.host": "width: 76px; background: [#555](https://github.com/lehni/vscode-titlebar-less-macos/issues/555) !important;",
    ".statusbar #status\\.host .codicon": "margin: 0 auto;"
  }
}
```
