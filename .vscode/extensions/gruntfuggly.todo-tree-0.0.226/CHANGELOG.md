...
- Fix bug when converting transparent colours

## v0.0.225 - 2023-04-10

- Add option to leave the focus in the tree when selecting a TODO
- Add support for 'none' and 'transparent' as named colours
