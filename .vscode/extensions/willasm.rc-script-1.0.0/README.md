...
![Dark+ Theme](https://github.com/willasm/rc-script/raw/HEAD/images/DarkPlus.png)

light+ Theme

![Light+ Theme](https://github.com/willasm/rc-script/raw/HEAD/images/LightPlus.png)

[Emerald Sky Theme](https://marketplace.visualstudio.com/items?itemName=willasm.emerald-sky)

![Emerald Sky Theme](https://github.com/willasm/rc-script/raw/HEAD/images/EmeraldSky.png)
...
## Release Notes
See the [Release Notes](https://github.com/willasm/rc-script/blob/HEAD/RELEASE.md) for details.
